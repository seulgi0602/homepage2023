   ...
   <div class="container">
      <div id="contents">
         <div id="bbs_wrap">
            <div class="board_view">
               ...
               <dl class="info_view2">
                  ...
                  <dt>작성일</dt>
                  <dd>
                     <fmt:formatDate value="${reservation.frstRegistPnttm}"
                        pattern="yyyy-MM-dd" />
               </dl>
               <div class="view_cont">
         ...
         <form action="${actionUrl}" method="post" id="frm" name="frm"
            ...
            <input type="hidden" name="resveSeCode"
               value="${searchVO.resveSeCode}"> <input type="hidden"
               name="reqstId" value="${searchVO.reqstId}"> <input
               type="hidden" name="resveDe" value="TYPE01">
