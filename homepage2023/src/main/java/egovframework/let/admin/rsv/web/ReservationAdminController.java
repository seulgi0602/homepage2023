...
public class ReservationAdminController {
   ...
   public String rsvSelectList(@ModelAttribute("searchVO") ReservationVO searchVO, HttpServletRequest request, ModelMap model, HttpSession session) throws Exception{
