...
<div class="bg-area change_box">
	<form id="frm" name="frm" action="/member/findIdComplete.do" method="post" onsubmit="return checjForm(this)" >
		<fieldset>
			...
			<div class="change_inp">
				...
				<div>
					...
					<select id="passwordHint" name="passwordHint" required>
						...
						<option value="2">애완견이름은?</option>
						<option value="3">취직하고싶은곳은??</option>
						<option value="4">여행가고싶은곳은?</option>
					</select>
				</div>
				<div>
