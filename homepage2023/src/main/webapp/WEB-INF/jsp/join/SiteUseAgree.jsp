...
<p>약관 및 개인정보 수집 · 이용 및 제 3자 제공 동의에 대한 내용을 자세히 읽어 보신 후 동의 여부를 결정하여 주시기 바랍니다.</p>
...
<div class="agree_box">
	<form id="agreeFrm" name="agreeFrm" action="/join/memberType.do" method="post">
		...
		필수(
			...
			<input type="radio" class="vMid" id="agree02-2" name="agree02" checked="checked">
...
<div class="agree_all">
	<label><input type="checkbox" id="check_all"/>모든약관에 동의합니다.</label>
</div>		
<div class="btn-cont">
